"""
Script para ejecutar el detector de plagio integrado
"""

import os
import time
from detector_plagio import detect_plagiarism

def main():
    # Ruta a la carpeta con los 100 archivos
    # Cambia esta ruta a la ubicación de tus archivos
